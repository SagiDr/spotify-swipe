      ...
      >
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-500 dark:text-gray-400 text-lg leading-relaxed">
            Discover new music by swiping, or test your knowledge
            with music trivia from your own playlists.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4 mb-10 text-sm">
          <div className="bg-gray-100 dark:bg-spotify-lightgray rounded-xl p-4">
            ...
            <p className="font-medium text-gray-700 dark:text-gray-200 mb-1">Swipe & Discover</p>
            <p className="text-gray-500 dark:text-gray-400 text-xs">Swipe through songs, like your favorites, and get a playlist</p>
          </div>
          <div className="bg-gray-100 dark:bg-spotify-lightgray rounded-xl p-4">
            <div className="text-2xl mb-2">
              <svg className="w-8 h-8 mx-auto text-purple-500" fill="currentColor" viewBox="0 0 24 24">
                <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 17h-2v-2h2v2zm2.07-7.75l-.9.92C13.45 12.9 13 13.5 13 15h-2v-.5c0-1.1.45-2.1 1.17-2.83l1.24-1.26c.37-.36.59-.86.59-1.41 0-1.1-.9-2-2-2s-2 .9-2 2H8c0-2.21 1.79-4 4-4s4 1.79 4 4c0 .88-.36 1.68-.93 2.25z" />
              </svg>
            </div>
            <p className="font-medium text-gray-700 dark:text-gray-200 mb-1">Music Trivia</p>
            <p className="text-gray-500 dark:text-gray-400 text-xs">Hear clips from your playlists and guess the song</p>
          </div>
        </div>
